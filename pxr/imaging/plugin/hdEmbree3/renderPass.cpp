...
HdEmbree3RenderPass::HdEmbree3RenderPass(HdRenderIndex *index,
...
HdEmbree3RenderPass::~HdEmbree3RenderPass()
{
...
bool
HdEmbree3RenderPass::IsConverged() const
{
...
void
HdEmbree3RenderPass::_Execute(HdRenderPassStateSharedPtr const& renderPassState,
    ...
    if (_lastSettingsVersion != currentSettingsVersion) {
        ...
        bool enableAmbientOcclusion =
            renderDelegate->GetRenderSetting<bool>(
                HdEmbree3RenderSettingsTokens->enableAmbientOcclusion, false);
        if (enableAmbientOcclusion) {
            _renderer->SetAmbientOcclusionSamples(
                renderDelegate->GetRenderSetting<int>(
                    HdEmbree3RenderSettingsTokens->ambientOcclusionSamples, 0));
        } else {
        ...
        _renderer->SetEnableSceneColors(
            renderDelegate->GetRenderSetting<bool>(
                HdEmbree3RenderSettingsTokens->enableSceneColors, true));
