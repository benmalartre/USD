...
//
#ifndef PXR_IMAGING_PLUGIN_HD_EMBREE3_RENDER_PASS_H
#define PXR_IMAGING_PLUGIN_HD_EMBREE3_RENDER_PASS_H
...
///
/// This class does so by raycasting into the embree scene via HdEmbree3Renderer.
///
class HdEmbree3RenderPass final : public HdRenderPass {
public:
    ...
    HdEmbree3RenderPass(HdRenderIndex *index,
                       HdRprimCollection const &collection,
                       HdRenderThread *renderThread,
                       HdEmbree3Renderer *renderer,
                       std::atomic<int> *sceneVersion);

    /// Renderpass destructor.
    virtual ~HdEmbree3RenderPass();
...
private:
    ...
    HdEmbree3RenderBuffer _colorBuffer;
    HdEmbree3RenderBuffer _depthBuffer;
...
#endif // PXR_IMAGING_PLUGIN_HD_EMBREE3_RENDER_PASS_H
