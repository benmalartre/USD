...
//
#ifndef PXR_IMAGING_PLUGIN_HD_EMBREE3_RENDER_BUFFER_H
#define PXR_IMAGING_PLUGIN_HD_EMBREE3_RENDER_BUFFER_H
...
class HdEmbree3RenderBuffer : public HdRenderBuffer
{
public:
    HdEmbree3RenderBuffer(SdfPath const& id);
    ~HdEmbree3RenderBuffer();

    /// Get allocation information from the scene delegate.
    /// Note: Embree3 overrides this only to stop the render thread before
...
#endif // PXR_IMAGING_PLUGIN_HD_EMBREE3_RENDER_BUFFER_H
