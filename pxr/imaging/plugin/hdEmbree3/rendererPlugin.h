...
//
#ifndef PXR_IMAGING_PLUGIN_HD_EMBREE3_RENDERER_PLUGIN_H
#define PXR_IMAGING_PLUGIN_HD_EMBREE3_RENDERER_PLUGIN_H
...
public:
    ...
    /// Construct a new render delegate of type HdEmbree3RenderDelegate.
    /// Embree3 render delegates own the embree scene object, so a new render
    /// delegate should be created for each instance of HdRenderIndex.
    ///   \return A new HdEmbree3RenderDelegate object.
...
#endif // PXR_IMAGING_PLUGIN_HD_EMBREE3_RENDERER_PLUGIN_H
