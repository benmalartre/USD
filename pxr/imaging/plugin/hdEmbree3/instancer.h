...
//
#ifndef PXR_IMAGING_PLUGIN_HD_EMBREE3_INSTANCER_H
#define PXR_IMAGING_PLUGIN_HD_EMBREE3_INSTANCER_H
...
/// \class HdEmbree3Instancer
///
/// HdEmbree3 implements instancing by adding prototype geometry to the BVH
/// multiple times within HdEmbree3Mesh::Sync(). The only instance-varying
/// attribute that HdEmbree3 supports is transform, so the natural
...
///
class HdEmbree3Instancer : public HdInstancer {
public:
    /// Constructor.
    ...
    HdEmbree3Instancer(HdSceneDelegate* delegate, SdfPath const& id,
...
private:
    ...
    // by HdEmbree3Mesh::Sync(), which is dispatched in parallel, so it needs
...
#endif  // PXR_IMAGING_PLUGIN_HD_EMBREE3_INSTANCER_H
