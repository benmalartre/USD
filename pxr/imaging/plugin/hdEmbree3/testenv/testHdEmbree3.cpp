...
#include "pxr/imaging/plugin/hdEmbree3/rendererPlugin.h"
...
// Extend it to draw a simple Embree3 scene.

class HdEmbree3_TestGLDrawing : public HdSt_UnitTestGLDrawing {
public:
    HdEmbree3_TestGLDrawing()
        : _smooth(false)
        , _instance(false)
        , _refined(false)
...
private:
    ...
    // renderer (e.g. OpenGL buffers, Embree3 scene objects). Each render
...
void HdEmbree3_TestGLDrawing::InitTest()
{
    // This test bypasses the hydra plugin system; it creates an Embree3
    ...
    // Prepare an Embree3 render task.  The render task is responsible for
    // rendering the scene.
...
void HdEmbree3_TestGLDrawing::DrawTest()
{
...
void HdEmbree3_TestGLDrawing::_RescaleDepth(float *buffer, int size)
{
...
void HdEmbree3_TestGLDrawing::_ColorizeId(int32_t *buffer, int size)
{
...
void HdEmbree3_TestGLDrawing::OffscreenTest()
{
...
void HdEmbree3_TestGLDrawing::UninitTest()
{
...
void HdEmbree3_TestGLDrawing::ParseArgs(int argc, char *argv[])
{
...
int main(int argc, char *argv[])
{
    ...
    HdEmbree3_TestGLDrawing driver;
